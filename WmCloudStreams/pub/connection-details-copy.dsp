<html>
    <head>
        ...
        <link rel="stylesheet" TYPE="text/css" HREF="css/webMethods.css"></link>    
    ...
    <body onload="load()">  
        ...
        <table id="mainTable" class="tableView" width="100%">
            ...
            <tr>
				...
				<td style="text-align: right; border: 0px;">Basic view| <a href="javascript:void(0)" onclick="javascript:ShowAllFields()">Advanced view</a>
				</td>
            </tr>
